...
$myPicture = new pImage($g_anchura,$g_altura,$myData);
$Settings = array("R"=>170, "G"=>183, "B"=>87, "Dash"=>1, "DashR"=>190, "DashG"=>203, "DashB"=>107);
$myPicture->drawFilledRectangle(0,0,$g_anchura,$g_altura,$Settings);
...
$myPicture->drawGradientArea(0,0,$g_anchura,$g_altura,DIRECTION_VERTICAL,$Settings);
} else {
  $myPicture->drawGradientArea(0,0,$g_anchura,$g_altura,DIRECTION_HORIZONTAL,$Settings);
}
...
$g_anchura1 = $g_anchura - 1;
$g_altura1 = $g_altura - 1;
$myPicture->drawRectangle(0,0,$g_anchura1,$g_altura1,array("R"=>0,"G"=>0,"B"=>0));
...
, "R"=>255, "G"=>255, "B"=>255);
$g_anchura2 = $g_anchura / 2;
$myPicture->drawText($g_anchura2,25,"My first pChart project",$TextSettings);

$myPicture->setShadow(FALSE);
$g_anchura25 = $g_anchura - 25;
$g_altura40 = $g_altura - 40;
$myPicture->setGraphArea(50,50,$g_anchura25,$g_altura40);
...
$g_anchura137 = $g_anchura - 137;
$myPicture->drawLegend($g_anchura137,16,$Config);
